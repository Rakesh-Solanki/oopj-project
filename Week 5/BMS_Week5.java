...
class User {
    ...
    private BankAccount account; // link to BankAccount

    public User(String username, String password, String email, double startingBalance) {
...
public class BMS_Week5 {
    ...
    static void registerUser() {
        ...
        // Create User object with BankAccount
